...
const okta = "https://upload.wikimedia.org/wikipedia/commons/5/5c/Okta_logo.svg";
const antd = "https://gw.alipayobjects.com/zos/rmsportal/KDpgvguMpGfqaHPjicRK.svg";
const trello = "https://upload.wikimedia.org/wikipedia/commons/7/7a/Trello-logo-blue.svg";
const slack = "https://upload.wikimedia.org/wikipedia/commons/b/b9/Slack_Technologies_Logo.svg";
...
const Underdog = () => {
    ...
    useEffect( () => {
        setProject(projectsList.filter(project => project.name === "Underdogdevs")[0])
    }, [])
            ...
            <div className="flexColNoWrap main mainContainer">
                ...
                <section className="flex rowWrap justifySpaceEvenly alignContentCenter alignItemsCenter alignContentStretch logos">
                    <article className="flex colNoWrap justifySpaceEvenly">
                        <p>
                        The final team project for the Bloom Institute of Technology Web development bootcamp.
                        I realized some forms for signing up and logging with Antd and implemented the authentification front-end with Okta.
                        </p>
                        <p>We worked as a team using Slack, Trello and GitHub</p>
                        <p>Links to the Underdogdevs website and repository:
                            <ul>
                                <li><a href={project.link}>the website</a></li>
                                <li><a href={project.github}>my GitHub fork</a></li>
                            </ul>
                        </p>
                    </article>
