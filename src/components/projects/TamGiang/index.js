        ...
        <>
        {
            ...
            <div className="flexColNoWrap main mainContainer">
                ...
                <section className="flex rowWrap justifySpaceEvenly alignItemsStart">
                    <article>
                        Exploratory statistics describe the characteristics of the dataset. But as datasets get bigger and more complex data visualization helps us to picture a global and intuitive representation of their parameters of interest.
                        A good data representation must be self-explanatory as it should help us to get an insight on the structure of the data and eventually formulate hypothesis. 
                    </article>
                    <aside className="flex colNoWrap">
                        <div className="asideImages">
                            <img loading="lazy" src={avgLength} alt="distribution curve" width="100%"/>
                        </div>
                    </aside>
                </section>
                <section className="flex rowWrap justifySpaceEvenly alignItemsStart">
                    <aside className="flex colNoWrap">
                        <div className="asideImages">
                            <img loading="lazy" src={frequencie} alt="distribution curve" width="100%"/>
                        </div>
                    </aside>
                    <article>
                        Once an hypothesis is formulated, it needs to be tested. The choice of the correct test depends on the nature of the data and the size of the dataset.
                        As well a confidence level needs to be decided before the test. 
                    </article>
                </section>
                <section className="flex rowWrap justifySpaceEvenly alignItemsStart">
                    <article>
                        Nowadays languages like R and python have libraries or even native function to run these tests and compute the p-value.
                        The p-value will let us decide wether to reject an hypothesis or to accept it. 
                        A typical use case of these statistical tests is, for example, to compare data coming from different sampling sites and decide wether or not the differences between these sampling site are significative or not. To know if the different comes from the randomness of the sampling or not so to speak.    
                    </article>
                    <aside className="flex colNoWrap">
                        <div className="asideImages">
                            <img loading="lazy" src={distribution} alt="distribution curve" width="100%"/>
                        </div>
                    </aside>
                </section>
            </div>:
